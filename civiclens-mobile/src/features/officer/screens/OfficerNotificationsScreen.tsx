/**
 * Officer NotificationsScreen - Display and manage officer notifications
 * Production-ready with officer-specific navigation and actions
 */
...
export const OfficerNotificationsScreen: React.FC = () => {
  ...
  const navigateToTaskDetail = useCallback((taskId?: number) => {
    if (!taskId) return;
  ...
  const handleNotificationPress = useCallback(async (notification: Notification) => {
    ...
    // Navigate based on related entity - Officer-specific navigation
    if (notification.related_task_id) {
      // Navigate to task detail (primary for officers)
      navigateToTaskDetail(notification.related_task_id);
    } else if (notification.related_report_id) {
      // Navigate to report detail
      navigateToReportDetail(notification.related_report_id);
    }
  }, [markAsRead, navigateToTaskDetail, navigateToReportDetail]);
        ...
        <View style={styles.notificationContent}>
          ...
          <View style={styles.textContainer}>
            ...
            <View style={styles.metaRow}>
              ...
              {/* Officer-specific badges */}
              {item.related_task_id && (
                <View style={styles.taskBadge}>
                  <Ionicons name="briefcase" size={12} color="#1976D2" />
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptySubtitle}>
        You're all caught up! Check back for task updates and system notifications.
      </Text>
    </View>
  );
